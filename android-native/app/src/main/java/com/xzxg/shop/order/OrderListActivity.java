...
public class OrderListActivity extends BaseShopActivity {
    ...
    private PigGuideController pigGuideController;
    ...
    private void renderOrders() {
        ...
        pigGuideController = new PigGuideController(this, api(), root);
        pigGuideController.show(com.xzxg.shop.navigation.Routes.ORDERS, ordersGuideContext(null), 24);
        loadOrders(page);
    }
    ...
    private void renderOrderItems(LinearLayout page, JSONArray items) {
        page.removeAllViews();
        if (pigGuideController != null) {
            pigGuideController.show(com.xzxg.shop.navigation.Routes.ORDERS, ordersGuideContext(items), 24);
        }
    ...
    private View createBackTopBar(String titleText) {
        return TopBarHelper.menuBar(this, BG_COLOR, titleText, () -> MainNavigationDrawer.show(this, root, Routes.ORDERS));
    }
}
