...
public class ChatActivity extends BaseShopActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadHomeCopy();
        validateStoredToken();
        handleInitialQuestion(getIntent());
    }
    ...
    protected void onNewIntent(Intent intent) {
        ...
        setIntent(intent);
        if (!handleInitialRoute(intent)) {
            handleInitialQuestion(intent);
        }
    }
    ...
    private void handleInitialQuestion(Intent intent) {
        String question = intent == null ? "" : intent.getStringExtra(Routes.EXTRA_INITIAL_QUESTION);
        ...
        if (intent != null) {
            intent.removeExtra(Routes.EXTRA_INITIAL_QUESTION);
        }
